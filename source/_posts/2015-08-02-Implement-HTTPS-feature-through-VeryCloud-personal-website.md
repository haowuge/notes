...
进入 VeryCloud 控制台，
![VeryCloud 控制台](https://static.gehaowu.com/notes/2015/08/VeryCloudSSL0.png)
选择 *云分发* -> *证书管理* -> *新建*
![新建证书](https://static.gehaowu.com/notes/2015/08/VeryCloudSSL1.png)
...
选择 *云分发* -> *频道管理* -> *新建*
![基础设置](https://static.gehaowu.com/notes/2015/08/VeryCloudAdd1.png)
频道选择你需要加速的二级域名，我使用 *www.gehaowu.com*
ICP 备案号会自动获取
加速类型选择云分发
源站填 *gehaowu.github.io* ，端口80
接着选择下一步
![策略设置](https://static.gehaowu.com/notes/2015/08/VeryCloudAdd2.png)
策略选择 *遵循源站* 就可以了，你也可以选择自定义，
接着再下一步
![高级设置](https://static.gehaowu.com/notes/2015/08/VeryCloudAdd3.png)
...
![DNSPod添加www记录](https://static.gehaowu.com/notes/2015/08/DNSPod.png)
...
```
![我的后台选项](https://static.gehaowu.com/notes/2015/08/VeryCloud1.png)
我的源站并没有使用Github，直接挂在朋友的VPS上的
![CURL](https://static.gehaowu.com/notes/2015/08/VeryCloud2.png)
...
<a href="https://creativecommons.org/licenses/by-nc-nd/4.0/deed.zh"><img src="https://static.gehaowu.com/notes/other/CC-BY-SA-ND.png" alt="署名-非商业性使用-禁止演绎 创意共享4.0国际许可证" /></a>
